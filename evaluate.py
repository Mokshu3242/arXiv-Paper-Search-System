...
# import everything we can from the other files
...
def run_bm25_search(es, query, top_k):
    # reuse bm25_search from hybrid_explain but add extra fields for evaluation
...
def run_hybrid_search(es, resources, query, top_k):
    # just call hybrid_search from hybrid_explain.py directly
